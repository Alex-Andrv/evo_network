...
task_name = "watts_strogatz_50_8_0.5_123_uniform_1-100_const_0.8"
solver_name, run_script = ("gen_tdg&1+1[10000]",lambda problem, seed: problem.solve_using_tdg_and_then_1p1(None, None,tss_stop_criteria.by_iteration_count(10000), seed))
