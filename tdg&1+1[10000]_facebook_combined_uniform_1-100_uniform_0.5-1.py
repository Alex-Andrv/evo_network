...
solver_name, run_script = ("tdg&1+1[10000]",lambda problem, seed: problem.solve_using_tdg_and_then_1p1(None, None,tss_stop_criteria.by_iteration_count(10000), seed))
