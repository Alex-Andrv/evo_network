...
solver_name, run_script = ("tdg_iter_descent_v5[10000, 1]",lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent_v5(None, None, tss_stop_criteria.by_iteration_count(10000), 1, seed))
seria = "seria_3"
