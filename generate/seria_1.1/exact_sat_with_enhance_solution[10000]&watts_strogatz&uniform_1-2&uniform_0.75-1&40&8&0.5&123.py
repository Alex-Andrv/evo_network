...
solver_name, run_script = ("exact_sat_with_enhance_solution[10000]",lambda problem, seed: problem.solve_using_sat_with_enhance_solution(tss_stop_criteria.by_iteration_count(10000), seed))
seria = "seria_1.1"
