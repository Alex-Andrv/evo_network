...
solver_name, run_script = ("tdg_iter_descent_IMP[5000, 1]",lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent_IMP(None, None, tss_stop_criteria.by_iteration_count(5000), 1, seed))
seria = "seria_4_0.5"
