...
solver_name, run_script = ("tdg_iter_descent[10000, 5]",lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent(None, None, tss_stop_criteria.by_iteration_count(10000), 5, seed))
seria = "seria_2"
