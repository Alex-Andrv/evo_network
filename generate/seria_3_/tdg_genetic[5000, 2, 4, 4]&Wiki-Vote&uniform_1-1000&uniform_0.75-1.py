...
solver_name, run_script = ("tdg_genetic[5000, 2, 4, 4]",lambda problem, seed: problem.solve_using_custom_ga(2, 4, 4, tss_stop_criteria.by_stagnation_count(10000), seed=seed))
seria = "seria_3"
