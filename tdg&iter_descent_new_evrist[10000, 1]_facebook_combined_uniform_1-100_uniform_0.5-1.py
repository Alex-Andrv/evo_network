...
task_name = "facebook_combined_uniform_1-100_uniform_0.5-1"
solver_name, run_script = ("tdg&iter_descent_new_evrist[10000, 1]",lambda problem, seed: problem.solve_using_tdg_and_then_iter_descent_v2(None, None, tss_stop_criteria.by_iteration_count(10000), 1, seed))
